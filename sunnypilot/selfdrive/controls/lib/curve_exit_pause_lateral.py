...
ENTRY_TORQUE = 600     # driver torque counts toward center to arm
...
KEEP_TORQUE = 250      # counts toward center to maintain the pause
KEEP_ANGLE = 4.0       # deg, below this the maneuver is over
RELEASE_GRACE = 0.6    # s after the driver releases before lateral resumes
